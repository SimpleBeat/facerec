...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://morning-chamber-08121.herokuapp.com/register', {
            method: 'post',
                    ...
                    <div className="measure">
                        <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                            ...
                            <div className="mt3">
                                ...
                                <input onChange={this.onEmailChange} className="pa2 input-reset ba bg-transparent hover-bg-gray hover-white w-100" type="email" htmlFor="email-address"  id="email-address" />
                            </div>
                            <div className="mv3">
